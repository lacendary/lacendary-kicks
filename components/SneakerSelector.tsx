  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-xl border-2 border-zinc-700 bg-[#111111] px-6 py-5 transition-all duration-200 hover:border-red-500 hover:shadow-lg"
      >
            ...
            return (
              <button
                ...
                className={`flex w-full items-center justify-between border-b border-zinc-800 px-5 py-4 text-left transition last:border-b-0 hover:bg-zinc-900 ${
                  isSelected ? "border-l-4 border-l-red-500 bg-zinc-900" : ""
                }`}
              >
